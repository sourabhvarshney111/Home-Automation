...
public class Text_processing extends Activity {
    ...
    public int txt_pro(String str1,TextView textView,TextView textView1) {
        ...
        if(textView1.getText().toString().equals("Unrecognized Command"))
            return 0;
        int x = noune.size();
        int y = verbe.size();
        ...
        if (x >= 1 && y >= 1) {
            ...
            textView.setText("You have given wrong command ");
            return -1;
        }
    }
